        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-br from-secondary-600 to-secondary-700 rounded-lg flex items-center justify-center shadow-lg">
                <ApperIcon name="Users" className="w-6 h-6 text-white" />
              </div>
              <div>
                <h1 className="text-xl font-bold bg-gradient-to-r from-secondary-600 to-secondary-600 bg-clip-text text-transparent">
                  ContactFlow
                </h1>
...
<NavLink
            ...
            >
              <ApperIcon name="Handshake" className="w-5 h-5 mr-2" />
              Deals
            </NavLink>
            <NavLink
              to="/tasks"
